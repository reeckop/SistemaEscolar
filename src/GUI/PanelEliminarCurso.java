...
public class PanelEliminarCurso extends javax.swing.JPanel {
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (eliminado != null) {
            ...
            JOptionPane.showMessageDialog(this, "No se encontró un curso con esa clave.", "Error",
                ...
                .addGroup(layout.createSequentialGroup().addGap(40, 40, 40)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGap(18, 18, 18)
                                        .addComponent(txtClave, javax.swing.GroupLayout.PREFERRED_SIZE, 150,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addComponent(btnEliminar, javax.swing.GroupLayout.PREFERRED_SIZE, 250,
                                        javax.swing.GroupLayout.PREFERRED_SIZE))
