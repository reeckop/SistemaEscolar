...
//        AVL<Sistema.ParPromedio> avl = new AVL<>();
//        for (Estudiante e : lista) {
//            avl.insert(new Sistema.ParPromedio(e));
//        }
//
//        // Obtener lista ordenada del AVL
//        List<Sistema.ParPromedio> ordenados = avl.obtenerListaInOrder();
//        
//        txtArea.setText("--- Estudiantes ordenados por Promedio (AVL) ---\n\n");
//        for (Sistema.ParPromedio par : ordenados) {
